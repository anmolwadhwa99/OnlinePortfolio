...
(function (factory) {
  ...
  function cloudinary_url(public_id, options) { 
    ...
    if (!cloud_name) throw "Unknown cloud_name" + $.cloudinary.config().cloud_name; // TODO added cloud_name to throw
  ...
  $.fn.unsigned_cloudinary_upload = function(upload_preset, upload_params, options) {
    ...
    html_options["class"] = "cloudinary_fileupload hand_interact" + (html_options["class"] || ""); // TODO added hand_interact class
    if (options.multiple) html_options.multiple = true;
    this.attr(html_options).cloudinary_fileupload(options);
    return this;
  };
  
  $.cloudinary.unsigned_upload_tag = function(upload_preset, upload_params, options, input_id) {
    // TODO added input_id
    return $('<input/>').attr({type: "file", name: "file", id: input_id}).unsigned_cloudinary_upload(upload_preset, upload_params, options);
  };
}));
